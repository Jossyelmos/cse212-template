...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue() adds new people to the front of the queue instead of
    // the back, causing the queue to behave as LIFO instead of FIFO.
    ...
    // Defect(s) Found: PersonQueue.Enqueue() adds people to the front of the queue, causing
    // incorrect FIFO ordering when people are added and re-added to the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: PersonQueue.Enqueue() adds people to the front of the queue instead of
    // the back, causing the circular queue to process people in the wrong order.
